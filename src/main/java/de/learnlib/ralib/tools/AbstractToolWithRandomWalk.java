...
public abstract class AbstractToolWithRandomWalk implements RaLibTool {
    ...
    protected static final ConfigurationOption.IntegerOption OPTION_WP_MIN_SIZE
    		= new ConfigurationOption.IntegerOption("wp.min.size",
    				"Minimum length of each counterexample generated by random Wp", 1, true);

    protected static final ConfigurationOption.IntegerOption OPTION_WP_RND_LENGTH
    		= new ConfigurationOption.IntegerOption("wp.rnd.length",
    				"Expected length of random walk in random Wp", -1, true);

    protected static final ConfigurationOption.IntegerOption OPTION_WP_BOUND
    		= new ConfigurationOption.IntegerOption("wp.bound",
    				"Maximum number of random walks with random Wp", -1, true);
